...
import dataDetail from "../../pages/Produk/CustomProject/data";
import dataContact from "../../pages/Support/ContactUs/data";
import dataMaintenance from "../../pages/Service/ReqMaintenance/data";
import dataServer from "../../pages/Service/RentServer/data";

export default function Table({ tHead, tBody, confirm, custom }) {
  ...
  const editServer = (id) => {
    navigate(`/service/server/edit/${id}`);
  };
                ...
                <>
                  <tr className="body-page relative text-sm text-center mb-2">
                    ...
                    <td>
                      <div className="btn-action flex gap-2 text-white justify-center">
                        <button
                          className="flex items-center px-3 py-1 bg-pws-purple rounded"
                          onClick={() => {
                            custom(true);
                          }}
                        >
                    ...
                    <ModalDetail
                      ...
                      data={dataDetail[index]}
                      path={path}
                      info={"Keterangan Custom Project"}
                    />
                  </tr>
                </>
              );
              ...
              return (
                <tr className="body-page relative text-sm text-center mb-2">
                  ...
                  <ModalDetail
                    ...
                    data={dataMaintenance[index]}
                    path={path}
                    info={"Keterangan Maintenance"}
                  />
                </tr>
              );
