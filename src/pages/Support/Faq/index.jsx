...
export default function Faq() {
  ...
  const toggle = () => {
    ...
    else document.querySelector(".circle").style.transform = "none";
            ...
            <div className="box-item w-full p-5">
              <div className="box-head flex justify-between">
                ...
                <div className="btn-question flex items-center">
                  <span className="text-sm me-3">Visible</span>
              ...
              <div className="box-body flex mt-4">
                <div className="box-drag flex items-center">
                  <div
                    className="line-item"
                ...
                <div className="item-question w-full flex justify-between p-5">
                  <p>Status dari order ?</p>

                  <div className="btn-question flex items-center">
                    <span className="text-sm me-3">Visible</span>

                    <button
                      className="btn-toggle flex items-center justify-end p-1 me-3"
                      style={
                        visibleQuestion
                          ? { backgroundColor: "#64DD94" }
                          : { backgroundColor: "#E85861" }
                    ...
                    >
                      <div className="circle flex items-center justify-center ">
                        <img
                          src={visibleQuestion ? iCheck : iCross}
                          alt="icon"
                        />
                      </div>
                    </button>
              ...
              <button className="w-full flex items-center justify-center p-4 mt-4 border-dashed border-2 border-[#AAAAAA] rounded">
                <svg
                  width="14"
                  height="14"
                  viewBox="0 0 14 14"
